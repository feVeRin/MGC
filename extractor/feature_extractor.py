...
# def resize_256(img_folder):    
#     img = np.load(img_folder[k])
#     img = np.resize(img, (256, 1292))
#     img = np.pad(img, ((0,0), (0, 4)))
#     img = img /np.linalg.norm(img)

#     return img
# def resize_128(img_folder):    
#     img = np.load(img_folder[k])
...
#     return img
# def resize_96(img_folder):    
#     img = np.load(img_folder[k])
#     img = np.resize(img, (96, 1292))
#     img = np.pad(img, ((0,0), (0, 4)))
#     img = img /np.linalg.norm(img)
...
for root, dirs, files in os.walk(audio_path):
    for fname in files:
        ...
        elif dataset == 'MICM' or dataset == 'Emotify-G':
            # MICM, Emotify-G
...
for k in range(len(img3_folder)):
    # img1 = resize_256(img1_folder)
    img1 = resize(img1_folder, 256)
    # img2 = resize_128(img2_folder)
    img2 = resize(img2_folder, 128)
    # img3 = resize_96(img3_folder)
