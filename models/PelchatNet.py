...
class PelchatNet(nn.Module):
    def __init__(self, conv_kernel_size=15):
        super(PelchatNet, self).__init__()
        self.layer1 = nn.Sequential(
            nn.Conv2d(3, 64, conv_kernel_size, stride=2, padding=2),
            nn.BatchNorm2d(64),
            nn.MaxPool2d(kernel_size=1, stride=2),
            nn.ReLU())
        self.layer2 = nn.Sequential(
            nn.Conv2d(64, 128, conv_kernel_size, stride=2, padding=2),
            nn.BatchNorm2d(128),
            nn.MaxPool2d(kernel_size=1, stride=2),
            nn.ReLU())
        self.layer3 = nn.Sequential(
            nn.Conv2d(128, 256, conv_kernel_size, stride=2, padding=2),
            nn.BatchNorm2d(256),
            nn.MaxPool2d(kernel_size=1, stride=2),
            nn.ReLU())
        self.layer4 = nn.Sequential(
            nn.Conv2d(256, 512, conv_kernel_size, stride=2, padding=2),
            nn.BatchNorm2d(512),
            nn.MaxPool2d(kernel_size=1, stride=2),
            nn.ReLU())
        self.layer5 = nn.Sequential(
            nn.Conv2d(512, 1024, conv_kernel_size, stride=2, padding=2),
            nn.BatchNorm2d(1024),
            nn.MaxPool2d(kernel_size=1, stride=2),
            nn.ReLU())
        self.layer6 = nn.Sequential(
            nn.Conv2d(1024, 2048, conv_kernel_size, stride=2, padding=2),
            nn.BatchNorm2d(2048),
            nn.MaxPool2d(kernel_size=1, stride=2),
            nn.ReLU())
        # mel
...
for i in range(10):
    ...
    model = PelchatNet(num_classes).to(device)
